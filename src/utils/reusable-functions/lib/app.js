export const app = {
  ...
  liquidifyStatic: function (figure, image) {
    image.style.display = 'none';
    figure.style.background = `url("${image.getAttribute(
      'src'
    )}") no-repeat center`;
  ...
  //       if (
  //         app.existsInDOM(options.triggers) &&
  //         app.existsInDOM(options.elements)
  //       ) {
  ...
  //       if (
  //         app.existsInDOM(options.container) ||
  //         typeof options.containerElement !== 'undefined'
  //       ) {
  ...
  //         ((app.existsInDOM(options.container) ||
  //           typeof options.containerElement !== 'undefined') &&
  //           options.controlToggle) ||
  //         ((app.existsInDOM(options.trigger) ||
  //           typeof options.triggerElement !== 'undefined') &&
  //           (app.existsInDOM(options.container) ||
  //             typeof options.containerElement !== 'undefined'))
  //       ) {
  ...
  //       if (
  //         app.existsInDOM(options.triggerSelector) &&
  //         app.existsInDOM(options.contentSelector)
  //       ) {
