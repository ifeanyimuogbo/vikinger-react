...
import { Avatar03, Avatar05 } from '../../api/data/images';
const ChatboxSidePanel = (props) => {
  return (
    <aside
          ...
          <div className="user-status-avatar">
            ...
            <div className="user-avatar small no-outline online">
              ...
              <div className="user-avatar-content">
                {/* HEXAGON */}
                <div className="hexagon-image-30-32" data-src={Avatar03}></div>
                {/* /HEXAGON */}
              </div>
              {/* /USER AVATAR CONTENT */}
        ...
        <div className="chat-widget-speaker left">
          ...
          <div className="chat-widget-speaker-avatar">
            ...
            <div className="user-avatar tiny no-border">
              ...
              <div className="user-avatar-content">
                {/* HEXAGON */}
                <div className="hexagon-image-24-26" data-src={Avatar03}></div>
                {/* /HEXAGON */}
              </div>
              {/* /USER AVATAR CONTENT */}
            </div>
        ...
        <div className="chat-widget-speaker left">
          ...
          <div className="chat-widget-speaker-avatar">
            ...
            <div className="user-avatar tiny no-border">
              ...
              <div className="user-avatar-content">
                {/* HEXAGON */}
                <div className="hexagon-image-24-26" data-src={Avatar05}></div>
                {/* /HEXAGON */}
              </div>
              {/* /USER AVATAR CONTENT */}
            </div>
...
ChatboxSidePanel.propTypes = {
  data: PropTypes.object,
  ui: PropTypes.object,
};
export default connect(mapStateToProps)(ChatboxSidePanel);
