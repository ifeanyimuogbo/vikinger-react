              ...
              <div className="user-status no-padding-top">
                ...
                <div className="user-status-avatar">
                  ...
                  <figure className="picture small round liquid">
                    <img src={MarketplaceItems07} alt="item-07" />
                  </figure>
                  {/* /PICTURE */}
                </div>
                {/* /USER STATUS AVATAR */}
                ...
                <div className="dropdown-box-list-item">
                  ...
                  <div className="cart-item-preview">
                    ...
                    >
                      {/* PICTURE */}
                      <figure className="picture medium round liquid">
                        <img src={MarketPlaceItems11} alt="item-11" />
                      </figure>
                      {/* /PICTURE */}
                    </a>
                    {/* /CART ITEM PREVIEW IMAGE */}
                ...
                <div className="dropdown-box-list-item">
                  ...
                  <div className="cart-item-preview">
                    ...
                    >
                      {/* PICTURE */}
                      <figure className="picture medium round liquid">
                        <img src={MarketPlaceItems10} alt="item-10" />
                      </figure>
                      {/* /PICTURE */}
                    </a>
                    {/* /CART ITEM PREVIEW IMAGE */}
                ...
                <div className="dropdown-box-list-item">
                  ...
                  <div className="cart-item-preview">
                    ...
                    >
                      {/* PICTURE */}
                      <figure className="picture medium round liquid">
                        <img src={MarketplaceItems04} alt="item-04" />
                      </figure>
                      {/* /PICTURE */}
                    </a>
                    {/* /CART ITEM PREVIEW IMAGE */}
