...
!(function (t, e) {
  ...
  var Pe = '\t\n\v\f\r                　\u2028\u2029\ufeff',
    ...
    He = function (t) {
      return function (e) {
        var r = String(b(e));
        return (
          1 & t && (r = r.replace(Ve, '')), 2 & t && (r = r.replace(Be, '')), r
        );
      };
    },
    ...
    return (
      ...
      (e.recalculate = function () {
        ...
        (this.contentWrapperEl.style.height = t ? 'auto' : '100%'),
          (this.placeholderEl.style.width = e ? r + 'px' : 'auto'),
          (this.placeholderEl.style.height = s + 'px');
        var c = this.contentWrapperEl.offsetHeight;
        (this.axis.x.isOverflowing = a > r),
        ...
        (this.axis.x.isOverflowing = this.axis.x.isOverflowing && a > n - u),
          (this.axis.y.isOverflowing = this.axis.y.isOverflowing && s > c - l),
      ...
      (e.onDragStart = function (t, e) {
        ...
        (this.axis[e].dragOffset = n - r.rect[this.axis[e].offsetAttr]),
          (this.draggedAxis = e),
  ...
  At(
    { target: 'Array', proto: !0, forced: Ft('reduce') },
    {
      reduce: function (t) {
        return mi(
          this,
  ...
  (ji || Ti) &&
    (Mi = function (t) {
      var e,
        ...
        o = this;
      return (
        Ti && (r = new RegExp('^' + o.source + '$(?!\\s)', Ai.call(o))),
        ji && (e = o.lastIndex),
        (n = ki.call(o, t)),
        ji && n && (o.lastIndex = o.global ? n.index + n[0].length : e),
        Ti &&
          n &&
          n.length > 1 &&
          Li.call(n[0], r, function () {
    ...
    return [
      ...
      function (t) {
        ...
        for (var a, c = [], l = 0; null !== (a = Pi(i, o)); ) {
          var u = String(a[0]);
          (c[l] = u),
            '' === u && (i.lastIndex = Di(o, st(i.lastIndex), s)),
            l++;
        }
        return 0 === l ? null : c;
      },
